  ...
  <v-ons-page>
    <v-ons-list>
      ...
      <v-ons-list-item :modifier="md ? 'nodivider' : ''">
        ...
        <label class="center">
          <v-ons-input v-model="name" float maxlength="20" placeholder="Name">
          </v-ons-input>
        </label>
      </v-ons-list-item>
      <v-ons-list-item :modifier="md ? 'nodivider' : ''">
      ...
      <v-ons-list-item>
        <div class="right right-label">
          Hello {{ name || 'anonymous' }}!<v-ons-icon
      ...
      <v-ons-list-item>
        ...
        Volume: {{ volume }}
        <span v-show="Number(volume) > 80">&nbsp;(careful, that's loud)</span>
      </v-ons-list-item>
      ...
      <ons-list-item>
        <div class="center">
          <v-ons-select v-model="selectedItem" style="width: 120px">
        ...
        <div class="right right-label">
          <s v-show="selectedItem !== 'Vue'">{{ selectedItem }}</s> Vue is
          awesome!
        </div>
      </ons-list-item>
      ...
      <v-ons-list-item>
        <div class="center">I love {{ selectedVegetable }}!</div>
      </v-ons-list-item>
